...
// @access Private
router.post('/', [auth, profileCreationValidators], async (req, res) => {
...
// @access Private
router.put('/experience', [auth, addExperienceValidators], async (req, res) => {
    const errors = validationResult(req)
    if (!errors.isEmpty()) return res.status(400).json({ errors: errors.array() })
...
// @access Private
router.put('/education', [auth, addEducationValidators], async (req, res) => {
    const errors = validationResult(req)
    if (!errors.isEmpty()) return res.status(400).json({ errors: errors.array() })
